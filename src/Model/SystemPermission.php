...
class SystemPermission extends Model
{
     ...
     * @var array
     */
    protected $fillable = ['name', 'slug', 'url', 'icon', 'route', 'component', 'status', 'is_external_link', 'is_display', 'type', 'order', 'parent_id', 'create_user_id', 'remark'];
     ...
     * @var array
     */
    protected $casts = ['permission_id' => 'integer', 'is_external_link' => 'integer', 'status' => 'integer', 'is_display' => 'integer', 'type' => 'integer', 'order' => 'integer', 'parent_id' => 'integer', 'create_user_id' => 'integer', 'created_at' => 'datetime', 'updated_at' => 'datetime'];
